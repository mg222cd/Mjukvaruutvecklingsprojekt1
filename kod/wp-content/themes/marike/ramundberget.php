...
<!-- CONTENT -->
		<div class="sixteen columns">
			...
			<div class="twelve columns alpha">
				<h1>Ramundberget</h1>
				<h3>Hyr boende i centrala Ramundberget</h3>
				<p>
			...
			<div class="four columns omega">
				...
				<p>
					...
					claritatem insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii 
					legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera 
					gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem 
